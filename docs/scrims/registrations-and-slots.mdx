...
without IGNs — one of the four things that break a hand-run slot list, covered in
[Hosting scrims from a Google Form: what breaks](https://finalist.live/blog/hosting-scrims-google-form-breaks).
