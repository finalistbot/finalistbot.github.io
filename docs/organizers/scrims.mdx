...
Pick the game, the mode, and the map. The **mode decides the team size**, which in turn
decides how large a lineup teams may bring. You don't set a roster limit anywhere.
...
| Max slots | How many teams get in. The rest go to the waitlist. |
...
![Scrim settings](./assets/scrim-settings.png)
