...
Invite the bot, then connect your server to your organization from the dashboard. See
[Connect your server](./discord/connect-server). Once connected, scrim announcements land
in the channel you choose, and members get `/scrim`, `/team`, `/me` and `/org` commands.
